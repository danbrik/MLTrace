...
export const sensorApi = {
  ...
  preview: (payload: { split_id: number; model_id?: number; window_length?: number; training?: import('./timeSeries/types').Parameters }, signal?: AbortSignal) => request<import('./timeSeries/types').PipelinePreview>('/api/time-series/pipelines/preview', { method: 'POST', body: JSON.stringify(payload), signal }),
