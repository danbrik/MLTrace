    ...
    LayerDefinition(
        ...
        config_schema={
            ...
            "properties": {
                ...
                "kernel_size_t": {"type": "integer", "label": "Kernel T", "minimum": 1, "default": 3},
                "kernel_size_xy": {"type": "integer", "label": "Kernel XY", "minimum": 1, "default": 3},
                "stride_t": {"type": "integer", "label": "Stride T", "minimum": 1, "default": 1},
                "stride_xy": {"type": "integer", "label": "Stride XY", "minimum": 1, "default": 1},
                "padding_t": {"type": "integer", "label": "Padding T", "minimum": 0, "default": 1},
                "padding_xy": {"type": "integer", "label": "Padding XY", "minimum": 0, "default": 1},
                "bias": {"type": "boolean", "label": "Bias", "default": True},
            },
        },
        shape_notes="Output size follows torch.nn.Conv3d semantics for T,H,W.",
    ),
    LayerDefinition(
        ...
        config_schema={
            ...
            "properties": {
                ...
                "padding_t": {"type": "integer", "label": "Padding T", "minimum": 0, "default": 1},
                "padding_xy": {"type": "integer", "label": "Padding XY", "minimum": 0, "default": 1},
                "output_padding_t": {"type": "integer", "label": "Output padding T", "minimum": 0, "default": 0},
                "output_padding_xy": {"type": "integer", "label": "Output padding XY", "minimum": 0, "default": 0},
                "bias": {"type": "boolean", "label": "Bias", "default": True},
            },
        },
        shape_notes="Output size follows torch.nn.ConvTranspose3d semantics for T,H,W.",
    ),
    LayerDefinition(
        type="BatchNorm3d",
        label="BatchNorm3d",
        category="Normalization 3D",
        input_rank=5,
        output_rank=5,
